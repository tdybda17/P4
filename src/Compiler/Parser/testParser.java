...
public class testParser/*@bgen(jjtree)*/implements testParserTreeConstants, testParserConstants {/*@bgen(jjtree)*/
 ...
 /*@bgen(jjtree) GRAPH_DCL1 */
  SimpleNode jjtn000 = new SimpleNode(JJTGRAPH_DCL1);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) VERTEX_LIST1 */
  SimpleNode jjtn000 = new SimpleNode(JJTVERTEX_LIST1);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) VALUE1 */
  SimpleNode jjtn000 = new SimpleNode(JJTVALUE1);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) FUNCTION_CALL1 */
  SimpleNode jjtn000 = new SimpleNode(JJTFUNCTION_CALL1);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) STMT1 */
  SimpleNode jjtn000 = new SimpleNode(JJTSTMT1);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) IF_STATEMENT */
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x400001c,0x400001c,0x1c,0x0,0x100100,0x4000000,0x4000000,0x0,0x0,0x0,0x0,0x10000,0x40000,0x1000,0x4000,0x5400420,0x5400420,0x5400420,0x0,0x0,0x5400420,0x0,0x1c,0x0,0x5400420,0x10011f,0x10011f,0x10011f,0x0,0x10011f,0x100103,0x3,0x4000000,0x0,0x0,};
   }
