...
import Compiler.Parser.PrintVisitor;import Compiler.Parser.whatever;import java.io.BufferedReader;
import java.io.File;
...
if (jjtc000) {
  ...
  jjtn000.jjtSetFirstToken(getToken(1));
    try {
      ...
      case REAL:
      case BOOLEAN:{
ASTDCL jjtn001 = new ASTDCL(JJTDCL);
...
ASTOBJECT_TYPE jjtn002 = new ASTOBJECT_TYPE(JJTOBJECT_TYPE);
...
if (jjtc000) {
  ...
  ASTOBJECT_TYPES jjtn000 = new ASTOBJECT_TYPES(JJTOBJECT_TYPES);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtn000.jjtSetFirstToken(getToken(1));
    try {
...
if (jjtc000) {
  ...
  ASTMEMBER_FUNCTION_CALL jjtn000 = new ASTMEMBER_FUNCTION_CALL(JJTMEMBER_FUNCTION_CALL);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtn000.jjtSetFirstToken(getToken(1));
    try {
...
if (jjtc001) {
  ...
  final public void dcl() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CREATE:{
ASTCREATE jjtn001 = new ASTCREATE(JJTCREATE);
      boolean jjtc001 = true;
      jjtree.openNodeScope(jjtn001);
      jjtn001.jjtSetFirstToken(getToken(1));
      try {
...
if (jjtc001) {
    ...
    case REAL:
    case BOOLEAN:{
ASTDCL jjtn002 = new ASTDCL(JJTDCL);
                                           boolean jjtc002 = true;
                                           jjtree.openNodeScope(jjtn002);
                                           jjtn002.jjtSetFirstToken(getToken(1));
      try {
...
if (jjtc000) {
 ...
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);
 jjtn000.jjtSetFirstToken(getToken(1));boolean isAssign = false;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IDENTIFIER:{
...
if (jjtc002) {
  ...
  ASTFUNCS_DCL jjtn000 = new ASTFUNCS_DCL(JJTFUNCS_DCL);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtn000.jjtSetFirstToken(getToken(1));
    try {
...
if (jjtc000) {
  ...
  final public void formal_parameters() throws ParseException {
    ...
    case GRAPH_TYPE:
    case COLLECTION_TYPE:{
ASTFORMAL_PARAMETERS jjtn001 = new ASTFORMAL_PARAMETERS(JJTFORMAL_PARAMETERS);
      boolean jjtc001 = true;
      jjtree.openNodeScope(jjtn001);
      jjtn001.jjtSetFirstToken(getToken(1));
      try {
...
/** Get the specific Token. */
  ...
  /*public static void useVisitorMethod(TestParserVisitor visitor, String filePath) {
        try {
