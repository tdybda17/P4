...
if (jjtc000) {
  ...
  final public void graph_element_dcl() throws ParseException {/*@bgen(jjtree) GRAPH_ELEMENT_DCL */
  ASTGRAPH_ELEMENT_DCL jjtn000 = new ASTGRAPH_ELEMENT_DCL(JJTGRAPH_ELEMENT_DCL);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtn000.jjtSetFirstToken(getToken(1));
    try {
